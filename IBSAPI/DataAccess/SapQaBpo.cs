...
public partial class SapQaBpo
{
    ...
    public string? BpoName1 { get; set; }

    public string? BpoName2 { get; set; }

    public string? Name3BpoRailways { get; set; }

    public string? Name4BpoOrgn1 { get; set; }

    public string? RemarksBpoOrgn2 { get; set; }
    ...
    public string? Street1BpoAdd1 { get; set; }

    public string? Street2BpoAdd2 { get; set; }

    public string? Street3BpoAdd3 { get; set; }

    public string? Street4BpoAdd4 { get; set; }

    public string? District { get; set; }

    public string? Street5BpoLocation { get; set; }

    public string? PostalCodeBpoPin { get; set; }
    ...
    public string? TelNumberBpoPhone { get; set; }

    public string? MobNumber { get; set; }

    public string? SmtpAddrBpoEmail { get; set; }
