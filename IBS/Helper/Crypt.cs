...
namespace IBS.Helper
{
    public static class Crypt
    {
        ...
        public static string EncryptText_New(string clearText, string Encryptionkey)
        {
            if (clearText == "0")
            {
                return "0";
        ...
        public static string DecryptText_New(string cipherText, string Encryptionkey)
        {
            if (cipherText == "0")
            {
                return "0";
        ...
        public static string DecryptStringAES(string cipherText, string strKey)
        {
            var keybytes = Encoding.UTF8.GetBytes(strKey);
            var iv = Encoding.UTF8.GetBytes("8080808080808080");
