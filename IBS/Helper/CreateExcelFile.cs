...
namespace IBS.Helpers
{
    public class CreateExcelFile
    {
        ...
        private static Columns SetDefaultColumnWidth()
        {
            ...
            //width of 1st Column
            columns.Append(new DocumentFormat.OpenXml.Spreadsheet.Column() { Min = 1, Max = 1, Width = 25, CustomWidth = true });
            //with of 2st Column
            columns.Append(new DocumentFormat.OpenXml.Spreadsheet.Column() { Min = 2, Max = 2, Width = 50, CustomWidth = true });
            //set column width from 3rd to 400 columns
            columns.Append(new DocumentFormat.OpenXml.Spreadsheet.Column() { Min = 3, Max = 400, Width = 10, CustomWidth = true });
            return columns;
        }
        ...
        private static Stylesheet GenerateStylesheet()
        {
            ...
            DocumentFormat.OpenXml.Spreadsheet.Column column = GenerateColumnProperty();
            Stylesheet styleSheet = new Stylesheet(fonts, fills, borders, cellFormats, column);

            return styleSheet;
        }

        private static DocumentFormat.OpenXml.Spreadsheet.Column GenerateColumnProperty()
        {
            return new DocumentFormat.OpenXml.Spreadsheet.Column
            {
                Width = 100,
                CustomWidth = true
            };
        ...
        private static CellFormats GenerateCellFormats()
        {
            CellFormats cellFormats = new CellFormats(
                ...
                new CellFormat(new DocumentFormat.OpenXml.Spreadsheet.Alignment() { WrapText = true, Vertical = VerticalAlignmentValues.Top }),

                // default2 - Cell StyleIndex = 1
                new CellFormat(new DocumentFormat.OpenXml.Spreadsheet.Alignment() { WrapText = true, Vertical = VerticalAlignmentValues.Top }) { FontId = 0, FillId = 0, BorderId = 1, ApplyBorder = true },

                // header - Cell StyleIndex = 2
                new CellFormat(new DocumentFormat.OpenXml.Spreadsheet.Alignment() { WrapText = true, Vertical = VerticalAlignmentValues.Top }) { FontId = 1, FillId = 0, BorderId = 1, ApplyFill = true },

                // DateTime DataType - Cell StyleIndex = 3
                new CellFormat(new DocumentFormat.OpenXml.Spreadsheet.Alignment() { Vertical = VerticalAlignmentValues.Top }) { FontId = 0, FillId = 0, BorderId = 1, ApplyBorder = true, NumberFormatId = 15, ApplyNumberFormat = true },

                // int,long,short DataType - Cell StyleIndex = 4
                new CellFormat(new DocumentFormat.OpenXml.Spreadsheet.Alignment() { WrapText = true, Vertical = VerticalAlignmentValues.Top }) { FontId = 0, FillId = 0, BorderId = 1, ApplyBorder = true, NumberFormatId = 1 },

                // decimal DataType  - Cell StyleIndex = 5
                new CellFormat(new DocumentFormat.OpenXml.Spreadsheet.Alignment() { WrapText = true, Vertical = VerticalAlignmentValues.Top }) { FontId = 0, FillId = 0, BorderId = 1, ApplyBorder = true, NumberFormatId = 2 }
                );
            return cellFormats;
        }
