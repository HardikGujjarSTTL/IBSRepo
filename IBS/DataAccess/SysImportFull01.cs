...
public partial class SysImportFull01
{
    public decimal? AbortStep { get; set; }

    public string? AccessMethod { get; set; }

    public string? AncestorObjectName { get; set; }

    public string? AncestorObjectSchema { get; set; }

    public string? AncestorObjectType { get; set; }
    ...
    public string? OrigBaseObjectName { get; set; }

    public string? OrigBaseObjectSchema { get; set; }
    ...
    public string? ProxyView { get; set; }
    ...
    public string? SrcCompat { get; set; }
    ...
    public string? TargetXmlClob { get; set; }

    public byte[]? TdeRewrappedKey { get; set; }
