...
public partial class IbsSapIntegration
{
    ...
    public string? BusinessPlace03 { get; set; }

    public string? SectionCode03 { get; set; }

    public string? Text04 { get; set; }

    public string? DateOfCompletion03 { get; set; }

    public string? GstPartner03 { get; set; }

    public string? PlaceOfSupply03 { get; set; }
}
