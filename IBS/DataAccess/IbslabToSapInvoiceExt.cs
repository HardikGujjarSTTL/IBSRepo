...
public partial class IbslabToSapInvoiceExt
{
    ...
    public string Reference01 { get; set; } = null!;
    ...
    public string Reference02 { get; set; } = null!;
    ...
    public string Reference03 { get; set; } = null!;
