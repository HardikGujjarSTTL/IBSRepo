        ...
        public CallsMarkedToIEModel GetReport(int GetIeCd, string UserId, string type)
        {
            ...
            if (type == "C")
            {
                ...
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ReportLstNew = JsonConvert.DeserializeObject<List<CallsMarkedToIEModelListNew>>(serializeddt, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
