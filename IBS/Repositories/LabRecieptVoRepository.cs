...
{
    public class LabRecieptVoRepository : ILabRecieptVoucherRepository
    {
        private readonly ModelContext context;

        public LabRecieptVoRepository(ModelContext context)
        {
        ...
        public DTResult<LabRecieptVoucherModel> GetVoucherList(DTParameters dtParameters)
        {
            ...
            query = from l in context.ViewVoucherLists
                    ...
                    select new LabRecieptVoucherModel
                    {
                        VCHR_NO = l.VchrNo,
        ...
        public string VoucherDetailsSave(LabRecieptVoucherModel model, string Region)
        {
            ...
            else
            {
                ...
                //GetValue2.ChqDt = Convert.ToDateTime(DateTime.ParseExact(model.CHQ_DT, "MM/dd/yyyy", null).ToString("dd/MM/yyyy"));
        ...
        {
            List<BPOlist> DropdownValues = null;
